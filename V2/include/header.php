	  ...
	  <div class="uk-container">
	    <div data-uk-navbar>
	      <div class="uk-navbar-left">
	        <a class="uk-navbar-item uk-logo uk-visible@m" href="https://t.me/X1_H9"><img src="../anonymousheader.svg" style='filter: invert(1); height: 30px; width: 30px; '>
        </a>
	      ...
	      <div class="uk-navbar-center uk-hidden@m">
	        <a class="uk-navbar-item uk-logo" href="https://t.me/X1_H9"><img src="../anonymousheader.svg" style='filter: invert(1); height: 30px; width: 30px; '></a>
	      </div>
